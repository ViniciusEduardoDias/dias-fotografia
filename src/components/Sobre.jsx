    ...
    <main className="w-full md:max-w-[900px] m-auto flex flex-col md:flex-row gap-6 items-center justify-center">
      <div className="max-w-[60%]">
        ...
        <p className="text-justify text-xl">
          Prazer te receber aqui! Me chamo Vinicius Dias e atuo no mercado da
          fotografia há mais de 6 anos. Desde sempre, tive a fotografia como uma
          forma de enxergar o mundo com mais sensibilidade e registrar momentos
          que merecem ser eternos. Afinal, a foto é a única recordação que pode
